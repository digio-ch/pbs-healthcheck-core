 ...
 */
final class Version20221206140842 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE TABLE aggregated_person_role (id INT NOT NULL, role_id INT NOT NULL, group_id INT NOT NULL, person_id INT DEFAULT NULL, midata_id INT DEFAULT NULL, nickname VARCHAR(255) NOT NULL, start_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, end_at TIMESTAMP(0) WITHOUT TIME ZONE, PRIMARY KEY(id))'
        );
