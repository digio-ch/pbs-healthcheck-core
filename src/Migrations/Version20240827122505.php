 ...
 */
final class Version20240827122505 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE login (id INT NOT NULL, person_id INT DEFAULT NULL, group_id INT DEFAULT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, is_group_change BOOLEAN NOT NULL, hashed_person_id VARCHAR(255) DEFAULT NULL, role VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
