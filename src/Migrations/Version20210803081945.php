 ...
 */
final class Version20210803081945 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE quap_aspect (id INT NOT NULL, questionnaire_id INT DEFAULT NULL, name_de VARCHAR(255) NOT NULL, name_fr VARCHAR(255) NOT NULL, name_it VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_37DF8DDCCE07E8FF ON quap_aspect (questionnaire_id)');
        $this->addSql('CREATE TABLE quap_help (id INT NOT NULL, question_id INT DEFAULT NULL, help_de VARCHAR(255) NOT NULL, help_fr VARCHAR(255) NOT NULL, help_it VARCHAR(255) NOT NULL, severity VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_5002CDF61E27F6BF ON quap_help (question_id)');
        $this->addSql('CREATE TABLE quap_question (id INT NOT NULL, aspect_id INT DEFAULT NULL, question_de VARCHAR(255) NOT NULL, question_fr VARCHAR(255) NOT NULL, question_it VARCHAR(255) NOT NULL, answer_options VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
