...
/**
 * @ORM\Table(name="hc_widget_demographic_group", indexes={
 ...
 * })
 * @ORM\Entity(repositoryClass="App\Repository\WidgetDemographicGroupRepository")
 * @ORM\HasLifecycleCallbacks()
 */
class WidgetDemographicGroup extends Widget
{
    /**
    ...
    /**
     * WidgetDemographicGroup constructor.
     */
