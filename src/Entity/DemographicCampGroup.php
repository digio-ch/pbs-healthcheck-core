...
/**
 * @ORM\Table(name="hc_demographic_camp_group", indexes={
...
class DemographicCampGroup
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="WidgetDemographicCamp", inversedBy="demographicCampGroups")
    ...
    /**
     * @param WidgetDemographicCamp $demographicCamp
     */
    public function setDemographicCamp(WidgetDemographicCamp $demographicCamp)
    {
