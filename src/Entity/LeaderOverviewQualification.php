...
class LeaderOverviewQualification
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="LeaderOverviewLeader", inversedBy="qualifications"))
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\QualificationType")
    ...
    public function setLeaderOverviewLeader(LeaderOverviewLeader $leaderOverviewLeader)
    {
